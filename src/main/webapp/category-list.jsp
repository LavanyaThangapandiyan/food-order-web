...
<%
	...
	<div>
		<div style="text-align:center"><h4>Lunch Dishes<br> We Serve The Taste you Love!.</h4></div>
	</div>
<br>
<br>
<center>
...
ResultSet rs=st.executeQuery("select id,name,price,Category,food_type from food_item where Category='"+categoryLunch+"'");
while(rs.next()){
     int id=rs.getInt(1);
