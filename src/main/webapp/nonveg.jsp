...
<%
	...
	<div>
		<div style="text-align:center"><h4>Non Vegetarian Dishes<br> We Serve The Taste you Love!.</h4></div>
	</div>
<br>
<br>
<center>
...
<tbody>
<%
String categoryLunch="Non Vegetarian";
Connection con=ConnectionUtil.init();
Statement st=con.createStatement();
ResultSet rs=st.executeQuery("select id,name,price,Category,food_type from food_item where food_type='"+categoryLunch+"'");
while(rs.next()){
     int id=rs.getInt(1);
